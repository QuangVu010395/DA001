...
delete BillInfo
insert BillInfo values (1,2,3)
insert BillInfo values (2,6,1)
insert BillInfo values (2,5,2)
...
Begin
	Insert Bill (
	DateCheckIn,
	DateCheckOut,idTable,status,discount)
	values 
	(GETDATE(), 
	NULL, 
	@idTable ,
...
Select * from Account
Insert into Account values ('baocao', N'Quang Vũ - Anh Vũ' , '1', 1)
